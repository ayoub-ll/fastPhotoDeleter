...
class _GalleryState extends State<Gallery> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        child: Row(
          ...
          children: <Widget>[
            Column(children: <Widget>[
              ...
              RaisedButton(
                  onPressed: () =>
                      _selectDate(context, startDate, 0), // Refer step 3
                  child: Text(
                    'Changer date',
                    style: TextStyle(
            ...
            Column(children: <Widget>[
              ...
              RaisedButton(
                  onPressed: () =>
                      _selectDate(context, endDate, 1), // Refer step 3
                  child: Text(
                    'Changer date',
                    style: TextStyle(
                        color: Colors.black, fontWeight: FontWeight.bold),
      ...
      RaisedButton(
          onPressed: () => _selectDate(context, endDate, 1), // Refer step 3
          child: Text(
            'Supprimer',
  ...
  _selectDate(BuildContext context, DateTime currentDate, int dateType) async {
